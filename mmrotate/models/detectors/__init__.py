...
# from .ours_rcnn import OursRCNN
from .ours_rcnn_old import OursRCNN
from .hybrid_det import HybridDet
...
__all__ = [
    ...
    'RotatedSingleStageDetector', 'RotatedFCOS', 'OursRCNN', 'HybridDet'
]
