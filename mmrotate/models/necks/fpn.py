...
class FPN_Dense(BaseModule):
    ...
    def __init__(self,
        ...
        super(FPN_Dense, self).__init__(init_cfg)
        ...
        self.BA = Boundary_Aggregation(in_channels[0])
    ...
    def forward(self, inputs):
        ...
        for i in range(used_backbone_levels - 1, 0, -1):
            ...
            if 'scale_factor' in self.upsample_cfg:
                ...
                laterals[i - 1] = self.BA(laterals[i - 1]) + F.interpolate(
