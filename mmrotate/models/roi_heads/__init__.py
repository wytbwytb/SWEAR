...
# from .ours_standard_roi_head import OursStandardRoIHead
from .ours_standard_roi_head_old import OursStandardRoIHead
from .oriented_standard_roi_head import RefinedOrientedStandardRoIHead

__all__ = [
    'RotatedBBoxHead', 'RotatedConvFCBBoxHead', 'RotatedShared2FCBBoxHead',
    'RotatedStandardRoIHead', 'RotatedSingleRoIExtractor',
    'OrientedStandardRoIHead', 'RoITransRoIHead', 'GVRatioRoIHead', 'OursStandardRoIHead', 'RefinedOrientedStandardRoIHead'
]
